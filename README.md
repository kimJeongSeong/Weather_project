...
## 🍀 Key Features
* **Pixel Art Graphics**: 모든 이미지를 직접 도트로 그려 개성 있는 8비트 감성을 구현했습니다.
* **Interactive Elements**: 정중앙 모니터 주변의 화분들을 클릭하여 프로젝트의 개요와 제작 정보를 탐색할 수 있습니다.
* **Visual Identity**: '하늘(날씨)'과 '방'의 결합을 통해 따뜻하고 싱그러운 색감을 활용했습니다.
