...
![홈페이지 메인 화면] 
<div align="center">
  <img src="https://github.com/user-attachments/assets/4b326a46-3953-400f-9fd0-bab8b53f81c1" width="80%" alt="site_window" />
</div>
...
> **"단순한 날씨 데이터를 넘어, 창문 너머의 감성을 시각화하다"**
> 
> 직접 디자인한 픽셀 아트 가구와 식물들로 채워진 아늑한 가상 방입니다. 실시간 날씨 정보를 단순히 데이터로 나열하지 않고, 방 안의 창문을 통해 변화하는 풍경으로 연출한 **인터랙티브 날씨 플랫폼**입니다. ☁️☀️
